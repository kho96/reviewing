...
$(function() {
	$("button").click(function() {
		location.href="/prac_servlet/prac02/prac02-02/studentRegisterPage2.jsp";
	});
});
</script>
</head>
<body>
	<table border="1">
		...
		<tr>
			...
			<td><a href="/prac_servlet/student.test2?mod=true&name=<%=vo.getName()%>">수정</a></td>
			<td><a href="/prac_servlet/student.test2?del=true&name=<%=vo.getName()%>">삭제</a></td>
		</tr>
		<%} %>	
